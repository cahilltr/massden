...
//Ripped from https://github.com/kboyd/Roc
 ...
 * CrossValidationResults.Builder} accepts collections of objects and the {@link
 * CrossValidationResults.PrimitivesBuilder} accepts arrays of primitive numbers.  (You
...
public class CrossValidationResults {
    ...
    CrossValidationResults(int[] truePositiveCounts, int[] falsePositiveCounts) {
     ...
     */
    public CrossValidationResults(int[] rankedLabels, int positiveLabel) {
    ...
    /**
     * Calls {@link #CrossValidationResults(int[], int)} with positiveLabel=1 (the
     * default positive label for integers).
     */
    public CrossValidationResults(int[] rankedLabels) {
        this(rankedLabels, 1);
    }
     ...
     * labels into some prespecified positive and negative signifiers.
     */
    public <T> CrossValidationResults(List<T> rankedLabels, T positiveLabel) {
     ...
     * @param positiveLabel See {@link #CrossValidationResults(int[], int)}.
     */
    ...
    static int[][] convexHullPoints(int[] xCoords, int[] yCoords) {
        ...
        for (int pointIndex = 0; pointIndex < xCoords.length; pointIndex++) {
            ...
            while (numberHullPoints >= 2 &&
                    CrossValidationResults.vectorCrossProduct(
     ...
     */
    public CrossValidationResults convexHull() {
        ...
        return new CrossValidationResults(hullPoints[1], hullPoints[0]);
    }
     ...
     * inconvenient (see {@link CrossValidationResults#CrossValidationResults(List, Object)}).  Therefore,
...
//        }
         ...
         */
        public CrossValidationResults build() {
            ...
            if (rankedLabels == null) {
                ...
                // Construct the curve
                return new CrossValidationResults(realPosCounts, realNegCounts);
            }

            // TODO pass weights if specified
            return new CrossValidationResults(rankedLabels, positiveLabel);
        }
...
//        }
    ...
    public String toString(boolean useTab) {
        ...
        myString += tabString + "Total Positives: " + this.totalPositives + System.lineSeparator();
        myString += tabString + "Total Negatives: " + this.totalNegatives + System.lineSeparator();
