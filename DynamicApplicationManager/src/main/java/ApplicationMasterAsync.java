...
public class ApplicationMasterAsync implements AMRMClientAsync.CallbackHandler {
  ...
  public ApplicationMasterAsync(String command, int numContainersToWaitFor, Configuration conf) {
    this.command = command;
    if (conf != null) {
      configuration = new YarnConfiguration(conf);
    } else {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ApplicationMasterAsync master = new ApplicationMasterAsync(command, n, null);
    master.runMainLoop();
  ...
  public void runMainLoop() throws Exception {
    ...
    AMRMClientAsync<ContainerRequest> rmClient = AMRMClientAsync.createAMRMClientAsync(100, new ApplicationMasterAsync(command,numContainersToWaitFor, configuration));
    

    rmClient.init(getConfiguration());
    rmClient.start();
    System.out.println("HERE: " + rmClient.getClusterNodeCount());
    ...
    System.out.println("HERE2: " + rmClient.getServiceState());

    // Register with ResourceManager
    System.out.println("[AM] registerApplicationMaster 0");
    rmClient.registerApplicationMaster("localhost", 9989, appMasterTrackingUrl);
