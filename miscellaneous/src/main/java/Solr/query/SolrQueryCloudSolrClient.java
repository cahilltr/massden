...
/**
 * Created by cahillt on 7/15/15.
 * For use with Solr 5x and higher.
 */
public class SolrQueryCloudSolrClient {
  private final static Logger logger = LoggerFactory.getLogger(SolrQueryCloudSolrClient.class);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      CloudSolrClient cloudSolrServer = new CloudSolrClient(zkconnect);
